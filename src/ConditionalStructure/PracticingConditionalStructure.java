...
public class PracticingConditionalStructure {
    ...
    public static void main(String[] args) {
      ...
      /*  Scanner sc = new Scanner(System.in);
        ...
        hora = sc.nextInt(); // vamos fazer a leitura
        ...
        //Encadeamento de estruturas condicionais, para fazer mais de duas possibilidades
...
ordem crescente ou decrescente
       ...
       //--------------------------------------------------------------------
        ...
        /*Faça um programa para ler as duas notas que um aluno  obteve  no primeiro e segundo semestre de uma disciplina
        anual. Em seguida, mostre a nota final que  o aluno obteve no ano juntamente com um texto explicativo. Caso a
        nota final do aluno  seja inferior a 60.00, mostre a mensagem "REPROVADO" conforme exemplo
         entradas 45.5, 31.3 saidas NOTA FINAL = 76.8
        ...
        /*Leia 3 valores de pontos flutuantes e efetue   cálculo das raízes da equação de bhaskara. Se não for possível
        calcular  as raízes, mostre a mensagem  correspodente "impossível calcular", caso haja  uma divisão por 0 ou raiz
        de um numero negativo.
         ...
         Exemplos de entrada 10.0 20.1 5.1,  0.0 20.0 5.0 / EXEMPLOS DESAIDA R1 = -0.29788, IMPOSSIVEL CALCULAR*/
    ...
    //------------------------------------------------------------------------------
        ...
        Em caso  de empate, mostrar apenas uma vez.  exemplos de entrada, 7 3 8  entrada 5 12 5 saida MENOR = 3 saida MENOS = 5*/
    ...
    /*    System.out.println("Digite os números");
        ...
        int b = sc.nextInt();
        int c = sc.nextInt();
 // fizemos um encadeamento de estruturas condicionais
        if (a < b && a < c) {
